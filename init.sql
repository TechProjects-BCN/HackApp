CREATE TABLE IF NOT EXISTS groups(groupId SERIAL PRIMARY KEY, username varchar(20), password varchar(20), groupName varchar(20), groupNumber BIGINT, isAdmin INT, eventID BIGINT, members TEXT DEFAULT '');
